...
columns_list = [
    ...
    'AAChange.refGene', 'AF', 'AF_raw', 'AF_male', 'AF_female', 'AF_afr', 'AF_ami', 'AF_amr', 'AF_asj', 'AF_eas',
    'AF_fin', 'AF_nfe', 'AF_oth', 'AF_sas', 'phyloP20way_mammalian', 'phyloP20way_mammalian_rankscore',
    'phastCons20way_mammalian', 'phastCons20way_mammalian_rankscore', 'SIFT_score', 'SIFT_converted_rankscore',
    'SIFT4G_score', 'SIFT4G_converted_rankscore', 'Polyphen2_HDIV_score', 'Polyphen2_HDIV_rankscore',
    'Polyphen2_HVAR_score', 'Polyphen2_HVAR_rankscore', 'LRT_score', 'LRT_converted_rankscore', 'LRT_Omega',
    'MutationTaster_score', 'MutationTaster_converted_rankscore', 'MutationAssessor_score',
    'MutationAssessor_rankscore', 'FATHMM_score', 'FATHMM_converted_rankscore', 'PROVEAN_score',
    'PROVEAN_converted_rankscore', 'VEST4_score', 'VEST4_rankscore', 'MetaSVM_score', 'MetaSVM_rankscore',
    'MetaLR_score', 'MetaLR_rankscore', 'Reliability_index', 'MetaRNN_score', 'MetaRNN_rankscore',
    'M-CAP_score', 'M-CAP_rankscore', 'REVEL_score', 'REVEL_rankscore', 'MutPred_score', 'MutPred_rankscore',
    'MVP_score', 'MVP_rankscore', 'gMVP_score', 'gMVP_rankscore', 'MPC_score', 'MPC_rankscore',
    'PrimateAI_score', 'PrimateAI_rankscore', 'DEOGEN2_score', 'DEOGEN2_rankscore', 'BayesDel_addAF_score',
    'BayesDel_addAF_rankscore', 'BayesDel_noAF_score', 'BayesDel_noAF_rankscore', 'ClinPred_score',
    'ClinPred_rankscore', 'LIST-S2_score', 'LIST-S2_rankscore', 'VARITY_R_score', 'VARITY_R_rankscore',
    'VARITY_ER_score', 'VARITY_ER_rankscore', 'VARITY_R_LOO_score', 'VARITY_R_LOO_rankscore',
    'VARITY_ER_LOO_score', 'VARITY_ER_LOO_rankscore', 'ESM1b_score', 'ESM1b_rankscore', 'EVE_score',
    'EVE_rankscore', 'AlphaMissense_score', 'AlphaMissense_rankscore', 'CADD_raw', 'CADD_raw_rankscore',
    'CADD_phred', 'DANN_score', 'DANN_rankscore', 'fathmm-MKL_coding_score', 'fathmm-MKL_coding_rankscore',
    'fathmm-XF_coding_score', 'fathmm-XF_coding_rankscore', 'Eigen-raw_coding', 'Eigen-raw_coding_rankscore',
    'Eigen-phred_coding', 'Eigen-PC-raw_coding', 'Eigen-PC-raw_coding_rankscore', 'Eigen-PC-phred_coding',
    'GenoCanyon_score', 'GenoCanyon_rankscore', 'integrated_fitCons_score', 'integrated_fitCons_rankscore',
    'integrated_confidence_value', 'GM12878_fitCons_score', 'GM12878_fitCons_rankscore',
    'GM12878_confidence_value', 'H1-hESC_fitCons_score', 'H1-hESC_fitCons_rankscore', 'H1-hESC_confidence_value',
    'HUVEC_fitCons_score', 'HUVEC_fitCons_rankscore', 'HUVEC_confidence_value', 'GERP++_NR', 'GERP++_RS',
    'GERP++_RS_rankscore', 'phyloP100way_vertebrate', 'phyloP100way_vertebrate_rankscore',
    'phyloP470way_mammalian', 'phyloP470way_mammalian_rankscore', 'phyloP17way_primate',
    'phyloP17way_primate_rankscore', 'phastCons100way_vertebrate', 'phastCons100way_vertebrate_rankscore',
    'phastCons470way_mammalian', 'phastCons470way_mammalian_rankscore', 'phastCons17way_primate',
    'phastCons17way_primate_rankscore', 'SiPhy_29way_pi', 'SiPhy_29way_logOdds', 'SiPhy_29way_logOdds_rankscore',
    'bStatistic', 'bStatistic_converted_rankscore'
]

# 设置文件路径
csv_path = '/mnt/nfs/yuht/test/pythonProject1/GNN-MAP/data/predictSNP.csv.hg38_multianno.csv'
csv1_path = '/mnt/nfs/yuht/test/pythonProject1/GNN-MAP/data/predictSNP.csv'
vcf_path = '/mnt/nfs/yuht/test/pythonProject1/GNN-MAP/data/splice/spliceAI_predictSNP.vcf'
output_path = '/mnt/nfs/yuht/test/pythonProject1/GNN-MAP/data/train_predictSNP.csv'
...
def merge(csv_path):
    ...
    df2 = pd.read_csv(csv1_path,low_memory=False)
